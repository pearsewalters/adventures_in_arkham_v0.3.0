...
GATE_SPAWN = 'constants.instability * ( math.log2( 1 + context.locations.currents.row( constants.name ).status.historical_clues) / math.log( 2 + context.locations.currents.row( constants.name ).status.clues, 3 ) )'
CLUE_SPAWN = 'constants.mystery * ( math.log2( 2 + context.locations.currents.row( constants.name ).status.historical_gates ) / math.log( 2 + context.locations.currents.row( constants.name ).status.clues, 3 ) )'
